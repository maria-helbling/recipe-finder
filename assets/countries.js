...
//these populate the states drop-down. Only called if country chosen is US
function populateStates(stateElementId){
	//Only doing this for the US, so no need to consider other indexes
	var selectedCountryIndex = 239;
...
//this function populates the country dropdown
function populateCountries(countryElementId, stateElementId){
	...
	// Note: we will not use this feature, since we only ever populate states in case the US is chosen
	// if( stateElementId ){
